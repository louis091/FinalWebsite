...
<body>
    ...
    <div class="split_2 space text-center text-white">
        ...
        <p>Mang sự hài lòng đến đôi chân của bạn.</p>
    </div>
    <!--End of Split--> 
    <!-- collection -->
                ...
                <div class = "collection-list mt-4 row gx-0 gy-3">
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            ...
                            <img src = "../assets/img/Shoes/giay1.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Nike Air Force 1 '07</p>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay2.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Metcon 9 EasyOn</p>
                            <span class = "fw-bold">2,669,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay3.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Pegasus FlyEase SE</p>
                            <span class = "fw-bold">4,515,149₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay4.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Gamma Force</p>
                            <span class = "fw-bold">4,302,649₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay5.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Air Force 1 LE</p>
                            <span class = "fw-bold">5,302,649₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay6.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike P-6000</p>
                            <span class = "fw-bold">3,759,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay7.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Invincible 3 By You</p>
                            <span class = "fw-bold">3,709,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay8.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Invincible 3</p>
                            <span class = "fw-bold">6,399,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay9.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Air Max 270</p>
                            <span class = "fw-bold">2,529,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay10.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Air Jordan 1 Mid</p>
                            <span class = "fw-bold">3,087,149₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay11.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Nike Air Force 1 '07 LV8 EMB</p>
                            <span class = "fw-bold">2,629,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Shoes/giay12.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary sale d-flex align-items-center justify-content-center">-20%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">Nike Air Max Excee</p>
                            <span class = "fw-bold">3,789,000₫</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="split_2 text-center text-white">
        ...
        <a class="btn text-white" href="#">Xem thêm</a>
    </div>
    <!--End of Split-->
    <!-- Slide-->  
