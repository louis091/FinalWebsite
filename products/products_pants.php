...
<body>
    ...
    <div class="split_2 space text-center text-white">
        <h2 class="text-uppercase">pants</h2>
        <p>Lắp đầy tủ đồ với những chiếc quần Nike</p>
    </div>
    <!--End of Split-->
    <!-- collection -->
    <section id = "collection" class = "py-5">
        <div class = "container">
            <div class = "title text-center">
                <h2 class = "position-relative d-inline-block fw-bold text-uppercase">tất cả sản phẩm</h2>
            </div>
            <div class = "row g-0">
                ...
                <div class = "collection-list mt-4 row gx-0 gy-3">
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            ...
                            <img src = "../assets/img/Pants/quan1.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Nike Sportswear Essentials</p>
                            <span class = "fw-bold">1,109,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan2.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Nike Club</p>
                            <span class = "fw-bold">981,149₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan3.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Nike Dri-FIT Phenom Elite</p>
                            <span class = "fw-bold">1,069,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan4.jpg" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Jordan Dri-FIT Sport</p>
                            <span class = "fw-bold">1,959,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan5.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">-15%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Jordan Flight Fleece</p>
                            <span class = "fw-bold">1,906,149₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan6.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">new</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike One</p>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan7.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">new</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Pro Dri-FIT</p>
                            <span class = "fw-bold">1,606,299₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan8.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">new</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Pro</p>
                            <span class = "fw-bold">1,319,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan9.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">-10%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">Nike Universa</p>
                            <span class = "fw-bold">1,779,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan10.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">-5%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                                <span class = "text-primary"><i class = "fas fa-star"></i></span>
                            ...
                            <p class = "text-capitalize my-1">Nike Zenvy</p>
                            <span class = "fw-bold">1,649,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan11.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Jordan Essentials</p>
                            <span class = "fw-bold">1,959,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Pants/quan12.jpg" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">-20%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Jordan Essentials</p>
                            <span class = "fw-bold">1,239,000₫</span>
                        </div>
                    </div>
                </div>
            </div>
