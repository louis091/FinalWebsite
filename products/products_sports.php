...
<body>
    ...
    <div class="split_2 space text-center text-white">
        <h2 class="text-uppercase">sportswear</h2>
        <p>Tự tin vượt qua giới hạn với các sản phẩm thể thao</p>
    </div>
    <!--End of Split-->
    <!-- collection -->
    <section id = "collection" class = "py-5">
        <div class = "container">
            <div class = "title text-center">
                <h2 class = "position-relative d-inline-block text-uppercase fw-bold">tất cả sản phẩm</h2>
            </div>
            <div class = "row g-0">
                ...
                <div class = "collection-list mt-4 row gx-0 gy-3">
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Los Angeles Lakers Association Edition <br>  Nike Dri-FIT NBA Swingman Jersey</p>
                            <span class = "fw-bold">2,709,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_2.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Stephen Curry Golden State Warriors <br> Men's Nike Dri-FIT NBA Swingman Jersey</p>
                            <span class = "fw-bold">3,669,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_3.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Kevin Durant 2023 All-Star Edition<br>Jordan Dri-FIT NBA Swingman Jersey</p>
                            <span class = "fw-bold">2,515,149₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_4.png" class = "w-100">
                        ...
                        <div class = "text-center">
                            ...
                            <p class = "text-capitalize my-1">Ja Morant Memphis Grizzlies 2023 Series <br> Men's Nike Dri-FIT NBA Swingman Jersey</p>
                            <span class = "fw-bold">2,302,649₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_5.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">-15%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">LeBron James Los Angeles Lakers City <br> Nike Dri-FIT NBA Swingman Jersey </p>
                            <span class = "fw-bold">2,302,649₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_6.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Go<br>Women's H-Waisted Leggings</p>
                            <span class = "fw-bold">2,759,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_7.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 new">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_8.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Zenvy<br>Women's H-Waisted Cropped Leggings</p>
                            <span class = "fw-bold">2,399,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_9.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">NikeCourt Dri-FIT Slam<br>Women's Tennis Tank Top</p>
                            <span class = "fw-bold">1,529,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 best">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_10.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">-15%</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Yoga Dri-FIT Luxe<br>Women's Cropped Tank</p>
                            <span class = "fw-bold">1,087,149₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_11.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Nike Alpha <br> Women's High Zip-Front Sports Bra</p>
                            <span class = "fw-bold">1,629,000₫</span>
                        </div>
                    </div>
                    ...
                    <div class = "col-md-6 col-lg-4 col-xl-3 p-2 feat">
                        <div class = "collection-img position-relative">
                            <!---ẢNH SẢN PHẨM PHẢI CÓ KÍCH THƯỚC 740 x 740 pixel-->
                            <img src = "../assets/img/Sport/Sport_12.png" class = "w-100">
                            <span class = "position-absolute bg-primary text-white d-flex align-items-center justify-content-center">sale</span>
                        </div>
                        <div class = "text-center">
                            <div class = "rating mt-3">
                            ...
                            <p class = "text-capitalize my-1">Jordan Sport <br> Women's Crop Top</p>
                            <span class = "fw-bold">1,789,000₫</span>
                        </div>
                    </div>
                </div>
            </div>
